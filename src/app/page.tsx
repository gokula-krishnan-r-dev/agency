      ...
      <div className="lg:px-24 px-2">
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
              <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
                ...
                <span className="text-blue-600">IT Solutions Hub!</span>
              </h1>
            ...
            <div className="relative ms-4">
              <img
                ...
                src="https://cdn.logojoy.com/wp-content/uploads/20220823143743/website-wireframe-example.gif"
        ...
        <>
          ...
          <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            {/* Title */}
            <div className="sm:w-1/2 mx-auto text-center mb-6">
            ...
            <div className="grid grid-cols-12 sm:flex sm:justify-center gap-6 sm:gap-x-12 lg:gap-x-20">
              <div className="col-span-6 text-center">
                <h4 className="text-xl md:text-4xl font-semibold text-gray-800 dark:text-neutral-200">
                  5+
                </h4>
                <h4 className="text-base text-gray-600 dark:text-neutral-400">
                  Project
                </h4>
              </div>
              <div className="col-span-6 text-center">
